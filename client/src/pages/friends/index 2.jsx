      ...
      <div className="page-container w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-surface-900 border-2 rounded-lg border-tonal-800 shadow-lg overflow-hidden mb-6">
            <h1 className="text-3xl font-bold text-light px-5 py-3 border-b border-tonal-800 z-10 relative">Friends</h1>
            <div className="p-4">
              {/* Friends Header with Requests Dropdown */}
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center">
                  {/* Remove friend count dot */}
                </div>
                <div className="relative">
                  <div className="w-36 h-8 bg-surface-700 rounded-lg animate-pulse"></div>
                </div>
              </div>
              {/* Toggle and Search */}
              <div className="mb-4">
                <div className="w-full bg-surface-700 rounded-lg mb-4 animate-pulse relative" style={{height: '40px'}}>
                  {/* Divider line */}
                  <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-px h-8 bg-surface-600"></div>
                </div>
              </div>
              <div className="relative mb-6">
                <div className="w-full bg-surface-700 rounded-lg animate-pulse relative" style={{height: '40px'}}>
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 bg-surface-600 rounded"></div>
                  <div className="absolute left-10 top-1/2 transform -translate-y-1/2 w-24 h-3 bg-surface-600 rounded"></div>
                </div>
              </div>
              {/* Content - Main content area */}
              <div className="bg-surface-700 rounded-lg animate-pulse" style={{height: '320px'}}>
                <div className="flex flex-col items-center justify-center h-full space-y-4">
                  {/* "Your friends list is empty" skeleton */}
                  <div className="h-4 w-40 bg-surface-600 rounded"></div>
                  
                  {/* "Add friends to see them here" skeleton */}
                  <div className="h-3 w-36 bg-surface-600 rounded"></div>
                  
                  {/* "Find Players" button skeleton */}
                  <div className="h-8 w-24 bg-surface-600 rounded mt-2"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-surface-900 border-2 rounded-lg border-tonal-800 shadow-lg overflow-hidden mb-6">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center">
                  <span className="ml-2 bg-primary-600 text-white text-xs font-medium px-2.5 py-1 rounded-full border border-primary-500">
                    {friends.length}
                  </span>
                </div>
                <div className="relative">
                  <button 
                    className="flex items-center gap-2 bg-surface-800 hover:bg-surface-700 transition-all duration-200 px-4 py-2 rounded-lg text-light relative border border-surface-700 hover:border-surface-600"
                  ...
                  >
                    ...
                    Friend Requests
                    <span className="bg-primary-600 text-white text-xs rounded-full h-5 min-w-[20px] flex items-center justify-center px-1 font-medium">
