    ...
    <div className="flex flex-col items-center justify-center mt-35">
        <div className="w-full max-w-sm p-4 border border-surface-600 rounded-lg shadow-sm sm:p-6 md:p-8 bg-tonal-900">
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <a href="https://respawnroom-server.onrender.com/auth/google" className="w-full flex justify-center items-center text-white bg-red-600 hover:bg-red-700 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-4">
